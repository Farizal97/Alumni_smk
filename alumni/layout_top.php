...
<head>
	...
	<title>Sistem Informasi Alumni SMK Bina Mandiri 2 Sukabumi - <?php echo $pagedesc ?></title>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="../foto/bm.jpg" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>Sistem Informasi Alumni</strong></div>
            ...
            <ul class="nav navbar-top-links navbar-right">
				<li class="dropdown dropdown-right">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<img src="../foto/<?php echo $sess_alumnifoto;?>" width="20px" height="20px" padding="0px">&nbsp;&nbsp;<?php echo ucfirst($sess_alumniname); ?>&nbsp;<i class="fa fa-caret-down"></i>
					</a>
					<ul class="dropdown-menu dropdown-user">
						<li><a href="pengaturan.php"><i class="fa fa-gear fa-fw"></i>&nbsp;Pengaturan Akun</a></li>
						<li class="divider"></li>
						<li><a href="pengaturan_ubah.php"><i class="fa fa-image fa-fw"></i>&nbsp;Ubah Foto</a></li>
						<li class="divider"></li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							...
							<h4><b>SMK Bina Mandiri 2 Sukabumi</b></h4>
						...
						<?php
							...
							if(isset($menuparent) && $menuparent == "profil") {
						...
						<?php
							if(isset($menuparent) && $menuparent == "event") {
								echo '<li class="active">';
							}
							else {
								echo '<li>';
                        ...
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-gear fa-fw"></i>&nbsp;Data Event<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Event Baru") {
										echo '<li><a href="event_baru.php" class="active">Event Baru</a></li>';
									}
									else {
										echo '<li><a href="event_baru.php">Event Baru</a></li>';
									}
									if($pagedesc == "Event Diikuti") {
										echo '<li><a href="event_diikuti.php" class="active">Event Diikuti</a></li>';
									}
									else {
										echo '<li><a href="event_diikuti.php">Event Diikuti</a></li>';
									}
								?>
							</ul><!-- /.nav-second-level -->
						<?php
							if(isset($menuparent) && $menuparent == "alumni") {
								echo '<li class="active">';
							}
							else {
								echo '<li>';
						...
						?>
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-group fa-fw"></i>&nbsp;Data Alumni<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Data Alumni") {
										echo '<li><a href="alumni.php" class="active">Data Alumni</a></li>';
									}
									else {
										echo '<li><a href="alumni.php">Data Alumni</a></li>';
									}
								?>
							</ul><!-- /.nav-second-level -->
						</li>
