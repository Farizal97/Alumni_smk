            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<?php
							if(isset($menuparent) && $menuparent == "tahun") {
								echo '<li class="active">';
							}
							else {
								echo '<li>';
						...
						?>
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-circle fa-fw"></i>&nbsp;Data Tahun<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Data Tahun") {
										echo '<li><a href="tahun.php" class="active">Data Tahun</a></li>';
									}
									else {
										echo '<li><a href="tahun.php">Data Tahun</a></li>';
									}
								?>
							</ul><!-- /.nav-second-level -->
						<?php
						...
						?>
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-th-large fa-fw"></i>&nbsp;Event<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Data Event") {
										echo '<li><a href="event.php" class="active">Data Event</a></li>';
									}
									else {
										echo '<li><a href="event.php">Data Event</a></li>';
									}
								?>
							</ul><!-- /.nav-second-level -->
						</li>
