...
<body style="background-color: #f1f4f7">
			...
			<div class="row">
				<div id="page-wrapper" class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4" style="background-color: #ffffff; border-radius: 3px; webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05); box-shadow: 0 1px 1px rgba(0,0,0,.05)">
					<div class="row">
						<div class="col-lg-12">
							<br/>
							<center><img src="foto/bm.jpg" width="120" height="120"></center>
							<h2 class="text-center">Sistem Informasi Alumni</h2>
							<h3 class="text-center"><b>SMK Bina Mandiri 2 Sukabumi</b></h3>
						</div>
					</div><!-- /.row -->
					<div class="row">
						<div class="col-lg-12">
	...
	<div class="navbar navbar-inverse navbar-fixed-bottom footer-bottom">
		<div class="container text-center">
			<p class="text-center" style="color: #D1C4E9; margin: 0 0 5px; padding: 0"><small>Sistem Informasi Alumni SMK Bina Mandiri 2 Sukabumi</small></p>
		</div>
	</div><!-- /.footer-bottom -->
